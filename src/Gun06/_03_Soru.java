...
//        Bu soruda tamamen XPATH kullanılacaktır.
    ...
    public void Test1()
    {
        ...
        for(WebElement e: urunFiyatlari) {
            ...
            urunFiyatToplam+= Double.parseDouble( e.getText().replaceAll("[^0-9,.]","") );
        }
        System.out.println("urunFiyatToplam = " + urunFiyatToplam);
        ...
        Assert.assertTrue("Toplam hatalı", urunFiyatToplam==itemTotal);
